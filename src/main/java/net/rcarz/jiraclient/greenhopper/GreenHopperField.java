...
final class GreenHopperField {
     ...
     */
    public static Instant getDateTime(Object dt) {
        if(dt == null || dt.equals(NO_DATE)){
            return null;
        }
        return DateTimeFormatter.ofPattern(DATE_TIME_FORMAT).parse((String) dt, Instant::from);
    }
